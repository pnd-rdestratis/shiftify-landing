...
const translations = {
  de: {
    ...
    step3: "Gemeinsam besprechen wir, wie Linetrace Ihre Anforderungen erfüllen kann",
  ...
  en: {
    ...
    thankYou: "Thank you",
    received: "We have received your request and look forward to discussing how Linetrace can help digitize production at",
    canHelp: ".",
    whatsNext: "What happens next",
    step1: "Our team will review your request",
    step2: "We will reach out to schedule a conversation",
    step3: "Together we will discuss how Linetrace can meet your needs",
